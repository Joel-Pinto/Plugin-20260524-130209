...
import org.minegen.plugin.commands.JokeCommand;
...
import org.minegen.plugin.handlers.JokeHandler;
...
public final class PluginMain extends JavaPlugin {
    ...
    public void reload() {
        ...
        if (jokeHandler != null) jokeHandler.reload();
    ...
    private void setupComponents() throws Exception {
        ...
        this.jokeHandler = new JokeHandler(this, this.configHandler);
    ...
    private void setupCommands() {
        ...
        var jokeCommand = new JokeCommand(this, this.messagesHelper, this.configHandler, this.messagesHandler);
        ...
        mainCommand.registerSubCommand("joke", jokeCommand);
